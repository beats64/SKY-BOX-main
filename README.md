...
wget -O box.sh https://github.com/beats64/SKY-BOX-main/raw/main/box.sh && chmod +x box.sh && clear && ./box.sh

<pre>wget -O box.sh https://github.com/beats64/SKY-BOX-main/raw/main/box.sh && chmod +x box.sh && clear && ./box.sh</pre>

### ARM beta使用方法
<details><summary>ARM beta使用方法</summary>
wget -O box.sh https://github.com/beats64/SKY-BOX-main/raw/main/armbox.sh && chmod +x box.sh && clear && ./box.sh

<pre>wget -O box.sh https://github.com/beats64/SKY-BOX-main/raw/main/armbox.sh && chmod +x box.sh && clear && ./box.sh</pre>
</details>
